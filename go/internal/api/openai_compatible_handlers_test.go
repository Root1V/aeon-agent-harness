...
func newOpenAICompatibleTestServer(t *testing.T, providerFails bool) *httptest.Server {
	...
	bundle := modelgateway.ModelPolicyBundleDoc{
		Profiles: []modelgateway.ModelProfileDoc{
			{Profile: "reasoning-test", Candidates: []modelgateway.CandidateDoc{{Provider: "fake", Model: "fake-model-v1", Modality: modelgateway.ModalityChat, Priority: 0}}},
			{
				Profile:            "restricted-test",
				Candidates:         []modelgateway.CandidateDoc{{Provider: "prometheus_inference", Model: "fake-model-v1", Modality: modelgateway.ModalityChat, Priority: 0}},
