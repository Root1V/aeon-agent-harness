...
CrewAIInteropWorkflow (INT-004), and their Activities. Also used directly (not via compose) by
...
from aeon_worker.activities.framework_adapter_activities import run_crewai_interop_activity, run_langgraph_interop_activity
...
async def main() -> None:
    ...
    worker = Worker(
        ...
        workflows=[AgentRunWorkflow, GraphRunWorkflow, DeepResearchWorkflow, LangGraphInteropWorkflow, CrewAIInteropWorkflow],
        activities=[
