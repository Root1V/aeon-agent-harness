...
GraphRunWorkflow (RUN-002), DeepResearchWorkflow (DX-001), and their Activities. Also used directly
(not via compose) by tests/integration/test_crash_resume.py and test_deep_research_workflow.py,
...
async def main() -> None:
    ...
    worker = Worker(
        ...
        workflows=[AgentRunWorkflow, GraphRunWorkflow, DeepResearchWorkflow],
        activities=[execute_tool_activity, decide_activity, plan_research_activity, research_subtask_activity, build_report_activity],
    )
